...
import com.himanshu.demo.springdatacassandra.model.{Person, PersonRepository}
...
class ControllerTest extends IntTestSpec {

  @MockBean var personRepository: PersonRepository = _
  @Autowired var controller: Controller = _
